...
#define LEFT_VRY_JOYSTICK 15
#define RIGHT_VRX_JOYSTICK 0
#define RIGHT_VRY_JOYSTICK 0

#define NUM_BUTTONS 13

//Defining main array which will contain the order of buttons.
...
//Defining array for various Gamepads
...
//code for bluetooth connectivity via function provided in blegamepad library
